    ...
    <div className="w-full max-w-3xl space-y-4 px-2">
      <div className="flex justify-between items-end">
        <div className="flex flex-col">
          ...
          <span className="font-display text-3xl leading-none text-white tracking-tighter italic drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
        ...
        <div className="text-right flex flex-col items-end pb-1">
          ...
          <span className="font-mono text-2xl text-primary font-black tabular-nums tracking-tighter leading-none">
            {progress.toFixed(1)}<span className="text-xl opacity-40 ml-2">%</span>
          </span>
        </div>
      </div>

      {/* Massive Industrial Power Bar */}
      <div className="relative h-8 w-full bg-black/60 border-4 border-primary/30 rounded-none overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)]">
